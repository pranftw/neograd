...
def test_linear():
  ...
  fn = ng.nn.Linear(5, 3)
  execute(fn, (input_data,), tuple(fn.get_params(as_dict=False,return_frozen=False)), tolerance=3e-7)
...
def test_conv2d():
  ...
  execute(fn1, (input_data,), tuple(fn1.get_params(as_dict=False,return_frozen=False)))
  execute(fn2, (input_data,), tuple(fn2.get_params(as_dict=False,return_frozen=False)))
  execute(fn3, (input_data,), tuple(fn3.get_params(as_dict=False,return_frozen=False)))
  execute(fn4, (input_data,), tuple(fn4.get_params(as_dict=False,return_frozen=False)))
